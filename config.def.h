...
static const float focuscolor[]            = COLOR(0xaaeeffff);
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_Tab,        spawn,          SHCMD("grim ~/Pictures/Screenshots/Screenshot-$(ls -1 ~/Pictures/Screenshots | wc -l).png") },
	{ MODKEY,                    XKB_KEY_z,          spawn,          SHCMD("'grim -g \"$(slurp)\" - | wl-copy'") },
